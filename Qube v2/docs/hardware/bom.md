...
| Componente     | Valor                | Cantidad | Notas                                                       |
| -------------- | -------------------- | -------- | ----------------------------------------------------------- |
| LED verde 5 mm | Difuso, Vf ≈ 2,1 V  | 1        | Testigo de panel en GPIO13. Un verde InGaN (Vf ≈ 3,1 V) no sirve directo al GPIO |
| Resistor 330 Ω | 1/8 W o más         | 1        | En serie con el LED. Desde el GPIO el nivel alto es **3,3 V**, no 5 V → ≈ 3,6 mA |
| Portaled 5 mm  | Con bisel            | 1        | Opcional, si el LED se lleva al panel                        |

Patrones de parpadeo y por qué GPIO13: [`pinout.md`](pinout.md#configuración-de-pines-esp32).
