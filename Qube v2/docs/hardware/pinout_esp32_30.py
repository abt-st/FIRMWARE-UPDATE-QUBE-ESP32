...
C_LED = "#8e24aa"   # LED de estado (testigo de panel)
...
LEFT = [
    ...
    ("D13", "LED de estado", C_LED, "330 ohm -> LED -> GND (izq. #2)"),
    ("D12", None, None, None),
    ("D14", None, None, None),
...
ax.text(50, 2.5,
        ...
        "Ninguno de los 10 GPIO en uso es pin de strapping (0, 2, 4, 5, 12, 15) -> el "
...
handles = [
    ...
    mpatches.Patch(color=C_LED, label="LED de estado (330 ohm a GND)"),
