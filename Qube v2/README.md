...
Cómo se opera —qué mira cada panel, cómo leer la autoprueba, qué significan los avisos y
qué hacer cuando la traza se congela— está en
[`docs/mine/TUTORIAL_APP.md`](docs/mine/TUTORIAL_APP.md).
