...
**Fuente:** `old resources/RESUMEN_HALLAZGOS.md` (Abril 27, 2026)  
**Propósito:** Síntesis ejecutiva de la investigación de viabilidad técnica en GitHub

---

## ❌ Pregunta Central

**¿Alguien ya hizo ESP32 + LM2596 + INA219 + L298N?**

**Respuesta:** **NO.** No existe ningún proyecto en GitHub que combine exactamente estos cuatro componentes. Sin embargo, la arquitectura **ES VIABLE Y VALIDADA** por bloques.
...
- ✅ **Framework más maduro:** `Ezward/Esp32CameraRover2` (46 ⭐, 2018–2024)
  - Closed-loop speed control, odometría, pose estimation, web interface
...
- 📚 **Papers académicos referenciados:**
  - "Modeling and control of a rotary inverted pendulum using various methods" (IEEE ICMA 2010)
...
- ✅ **Maduro y accesible:** ~$1–3 USD en módulos breakout
...
1. **VIBRACIÓN DEL SISTEMA** (ebrahimabdelghfar, 2023)
   ...
   - Solución: Filtrado PWM + capacitores 100 µF
...
3. **RUIDO EN MEDICIONES** (común en sistemas switchmode)
   - Causa: L298N @ 40 kHz interfiere ADC ESP32
...
**vs QUBE Original:** $2,500–3,500 (hasta 70× más caro)
...
4. ✅ Costo 25–50× menor que QUBE
5. ✅ Documentación accesible
6. ✅ Precursores académicos validados (Rotary-Inverted-Pendulum 2023)

**Diferencial clave:** Nadie ha hecho ESP32 + TODOS estos componentes integrados.  
...
*Investigación completada: Abril 27, 2026 | Actualizado: Mayo 26, 2026*